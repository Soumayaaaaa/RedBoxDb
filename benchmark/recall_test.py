...
def run_recall(host, port, db_size, k, seed=42):
...
def main():
    ...
    print(f"  dim={DIM}  queries={QUERIES}  clusters={NUM_CLUSTERS}  probes={NUM_PROBES}  search_k={k}")
    print("=" * 72)
    ...
    for db_size in DB_SIZES:
        recall, insert_time, search_time, capacity, kmeans_fired = run_recall(args.host, args.port, db_size, k)
